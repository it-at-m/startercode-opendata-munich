...
With this repo you get starter code for **all CSV data sets** (currently 2) that are available in the [data shop of the Statistical Office of Canton Zurich](https://www.zh.ch/de/politik-staat/opendata.zhweb-noredirect.zhweb-cache.html?keywords=ogd#/). 
...
<sub>Latest update: **2023-09-21 14:24:26**<sub>
