...
[Direct data shop link for dataset](https://www.zh.ch/de/politik-staat/opendata.html#/datasets/32@statistisches-amt-kanton-zuerich)
...
- **Keyword** `['bezirke', 'gemeinden', 'handaenderungen', 'immobilien', 'kanton_zuerich', 'stockwerkeigentum', 'wohnungen', 'ogd']`
