...
[Direct data shop link for dataset](https://www.zh.ch/de/politik-staat/opendata.html#/datasets/142@statistisches-amt-kanton-zuerich)
...
- **Keyword** `['bezirke', 'gemeindefinanzen', 'gemeinden', 'kanton_zuerich', 'nettoaufwendungen', 'oeffentliche_finanzen', 'rechtsschutz', 'sicherheit', 'ogd']`
