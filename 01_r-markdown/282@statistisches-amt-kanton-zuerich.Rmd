...
[Direct data shop link for dataset](https://www.zh.ch/de/politik-staat/opendata.html#/datasets/282@statistisches-amt-kanton-zuerich)
...
- **Modified** `2019-10-21T10:29:47`
- **Startdate** `2003-12-31`
- **Enddate** `2019-12-31`
- **Theme** `['Politik']`
- **Keyword** `['bezirke', 'gemeinden', 'kanton_zuerich', 'nationalratswahlen', 'politik', 'wahlbeteiligung', 'wahlen', 'ogd']`
...
# Distribution 0
# Ktzhdistid               : 212
# Title                    : Wahlbeteiligung Nationalrat [%]
# Description              : None
