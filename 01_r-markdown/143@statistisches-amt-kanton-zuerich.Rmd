...
[Direct data shop link for dataset](https://www.zh.ch/de/politik-staat/opendata.html#/datasets/143@statistisches-amt-kanton-zuerich)
...
- **Keyword** `['bauinvestitionen', 'bautaetigkeit', 'bezirke', 'gebaeudeart', 'gemeinden', 'kanton_zuerich', 'ogd']`
