...
[Direct data shop link for dataset](https://www.zh.ch/de/politik-staat/opendata.html#/datasets/42@statistisches-amt-kanton-zuerich)
...
- **Keyword** `['bezirke', 'gemeinden', 'kanton_zuerich', 'schueler', 'schuelerinnen', 'schulen', 'sekundarschule', 'ogd']`
