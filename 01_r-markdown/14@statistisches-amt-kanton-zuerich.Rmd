...
[Direct data shop link for dataset](https://www.zh.ch/de/politik-staat/opendata.html#/datasets/14@statistisches-amt-kanton-zuerich)
...
- **Keyword** `['betten', 'bezirke', 'gemeinden', 'hotelbetriebe', 'hotellerie', 'kanton_zuerich', 'ogd']`
