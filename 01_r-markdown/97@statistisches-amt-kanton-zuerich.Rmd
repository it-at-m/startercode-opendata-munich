...
[Direct data shop link for dataset](https://www.zh.ch/de/politik-staat/opendata.html#/datasets/97@statistisches-amt-kanton-zuerich)
...
- **Keyword** `['bautaetigkeit', 'bezirke', 'gebaeude', 'gebaeudeart', 'gemeinden', 'infrastruktur', 'kanton_zuerich', 'ogd']`
...
# Distribution 0
# Ktzhdistid               : 78
# Title                    : Geb.Vol. Infrastruktur: Zunahme [%]
# Description              : None
