...
[Direct data shop link for dataset](https://www.zh.ch/de/politik-staat/opendata.html#/datasets/214@statistisches-amt-kanton-zuerich)
...
- **Keyword** `['berufsschule', 'bezirke', 'gemeinden', 'kanton_zuerich', 'schueler', 'schuelerinnen', 'schulen', 'ogd']`
